...
function Immigration:_simplify_to_significant_figures(num, figures)
   local x = figures - math.ceil(math.log10(math.abs(num)))
   return math.floor(num*(10^x)+0.5)/(10^x)
end

function Immigration:_find_requirements_by_type_and_pop(available, type, num_citizens, significant_figures)
